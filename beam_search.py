...
class BeamSearch:
    ...
    def write_beam_search_melody(self):
        ...
        for i in tqdm(range(self.no_measures), ncols=75):
...
class Candidate:
    ...
    def predict_k_best(self, k, model, cand_list, chords, prob_scaling, weighting):
        ...
        Returns:
            Appends k best candidates to the specified list '''
        ...
        # Scale probabilities and take log probability;
        # weight and sum them with previous probabilities
        if prob_scaling < 1:
